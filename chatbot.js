...
productos: {
    ...
    response: `
        <p>Ofrecemos una amplia variedad de productos y servicios. Aquí tienes nuestras termas solares y sus características principales:</p>
...
function addMessage(content, sender) {
    ...
    messageDiv.innerHTML = content; // <-- aquí el cambio importante
